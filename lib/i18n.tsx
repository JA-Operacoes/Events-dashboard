...
const DICT = {
  pt: {
    ...
    "financeiro.kpi.ingressos": "Ingressos comprados",
    ...
    "operacional.donut.desc": "participação de cada serviço no total contratado",
  ...
  en: {
    ...
    "financeiro.kpi.ingressos": "Tickets purchased",
    ...
    "operacional.donut.desc": "share of the total contracted, per service",
