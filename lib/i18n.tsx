...
const DICT = {
  pt: {
    ...
    "operacional.kpi.diarias": "Diárias (itens × dias)",
    "operacional.kpi.pedidos": "Pedidos",
    "operacional.kpi.expositores": "Expositores atendidos",
    ...
    "operacional.local.title": "Por localização",
    "operacional.local.desc": "itens contratados por pavilhão/setor",
    "operacional.local.empty.title": "sem localização",
    "operacional.local.empty.desc": "aparece aqui quando a planilha trouxer a coluna de localização",
    ...
    "operacional.footnote": "Painel sem dados de produção — conecte a API externa em lib/dataSource.ts (função fetchOperacional).",
  ...
  en: {
    ...
    "operacional.kpi.diarias": "Item-days (items × days)",
    "operacional.kpi.pedidos": "Orders",
    "operacional.kpi.expositores": "Exhibitors served",
    ...
    "operacional.local.title": "By location",
    "operacional.local.desc": "items contracted per hall/area",
    "operacional.local.empty.title": "no location data",
    "operacional.local.empty.desc": "appears here once the spreadsheet provides the location column",
    ...
    "operacional.footnote": "No production data — wire up the external API in lib/dataSource.ts (fetchOperacional).",
    "operacional.search": "exhibitor, tax ID or booth",
    "status.confirmado": "Confirmed",
    "status.atendido": "Fulfilled",
