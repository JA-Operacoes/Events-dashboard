...
const DICT = {
  pt: {
    ...
    "shell.nav.operacional": "Operacional",
    ...
    "col.status": "Status",
    "col.servico": "Serviço",
    "col.nomeFantasia": "Nome fantasia",
    "col.estande": "Estande",
    "col.localizacao": "Localização",
    "col.tipoEstande": "Tipo de estande",
    "col.quantidade": "Qtd",
    "col.dias": "Dias",
    "col.dataInicio": "Data inicial",
    "col.dataFim": "Data final",
    "col.horaInicio": "Hora inicial",
    "col.horaFim": "Hora final",
    "col.turno": "Turno",
    "col.nome": "Nome",
    ...
    "module.operacional.title": "Operacional",
    "module.operacional.desc": "Serviços contratados pelos expositores — recepcionista, limpeza e afins.",
    ...
    "financeiro.kpi.ingressos": "Pessoas credenciadas",
    "financeiro.kpi.comparecimento": "Comparecimento",
    "financeiro.kpi.emAberto": "Valor em aberto",
    "financeiro.timeline.title": "Recebimentos no período",
    "financeiro.timeline.desc": "valor recebido por dia",
    "financeiro.timeline.empty.title": "sem série temporal",
    "financeiro.timeline.empty.desc": "a curva de recebimentos aparece aqui quando houver data de pagamento",
    ...
    "financeiro.origem.all": "Geral",
    "financeiro.origem.expositor": "Expositor",
    "financeiro.origem.ingresso": "Ingresso",
    "status.pago": "Pago",
    "status.pendente": "Em aberto",
    "status.cortesia": "Cortesia",
    "status.atrasado": "Atrasado",

    "operacional.title": "Serviços contratados",
    "operacional.kpi.itens": "Serviços contratados",
    "operacional.kpi.servicosPorExpositor": "Média de serviços por expositor",
    ...
    "operacional.donut.desc": "quantos itens foram contratados em cada serviço — clique para filtrar a tela",
    "operacional.donut.empty.title": "sem serviços",
    "operacional.donut.empty.desc": "a participação de cada serviço aparece aqui depois do primeiro import",
    "operacional.ranking.title": "Top expositores",
    "operacional.ranking.desc": "quem mais contratou serviços",
    "operacional.ranking.empty.title": "sem ranking",
    "operacional.ranking.empty.desc": "os expositores com mais itens contratados aparecem aqui",
    "operacional.tipo.title": "Por tipo de estande",
    "operacional.tipo.desc": "itens contratados por tipo de estande",
    "operacional.tipo.empty.title": "sem tipo de estande",
    "operacional.tipo.empty.desc": "aparece aqui quando a planilha trouxer a coluna de montagem/tipo de estande",
    "operacional.status.title": "Status dos pedidos",
    "operacional.status.desc": "distribuição por situação",
    "operacional.table.title": "Serviços contratados",
    "operacional.table.desc": "cada linha da planilha de contratação",
    "operacional.table.empty.title": "nenhum pedido carregado",
    "operacional.table.empty.desc": "os pedidos de serviço aparecem aqui após importar a planilha ou conectar a API",
    "operacional.table.count": "serviço(s)",
    "operacional.table.countZero": "0 serviços",
    "operacional.search": "expositor, CNPJ ou estande",
  ...
  en: {
    ...
    "shell.nav.operacional": "Operations",
    ...
    "col.status": "Status",
    "col.servico": "Service",
    "col.nomeFantasia": "Trade name",
    "col.estande": "Booth",
    "col.localizacao": "Location",
    "col.tipoEstande": "Booth type",
    "col.quantidade": "Qty",
    "col.dias": "Days",
    "col.dataInicio": "Start date",
    "col.dataFim": "End date",
    "col.horaInicio": "Start time",
    "col.horaFim": "End time",
    "col.turno": "Shift",
    "col.nome": "Name",
    ...
    "module.operacional.title": "Operations",
    "module.operacional.desc": "Services ordered by exhibitors — receptionists, cleaning and the like.",
    ...
    "financeiro.kpi.ingressos": "People credentialed",
    "financeiro.kpi.comparecimento": "Attendance",
    "financeiro.kpi.emAberto": "Outstanding amount",
    "financeiro.timeline.title": "Collections over time",
    "financeiro.timeline.desc": "amount collected per day",
    "financeiro.timeline.empty.title": "no time series yet",
    "financeiro.timeline.empty.desc": "the collections curve appears here once there is a payment date",
    ...
    "financeiro.origem.all": "All",
    "financeiro.origem.expositor": "Exhibitor",
    "financeiro.origem.ingresso": "Tickets",
    "status.pago": "Paid",
    "status.pendente": "Open",
    "status.cortesia": "Complimentary",
    ...
    "operacional.donut.desc": "how many items were contracted per service — click to filter the screen",
    "operacional.donut.empty.title": "no services yet",
    "operacional.donut.empty.desc": "the share of each service appears here after the first import",
    "operacional.ranking.title": "Top exhibitors",
    "operacional.ranking.desc": "who contracted the most services",
    "operacional.ranking.empty.title": "no ranking yet",
    "operacional.ranking.empty.desc": "the exhibitors with the most contracted items appear here",
    "operacional.tipo.title": "By booth type",
    "operacional.tipo.desc": "items contracted per booth type",
    "operacional.tipo.empty.title": "no booth type data",
    "operacional.tipo.empty.desc": "appears here once the spreadsheet provides the booth type column",
    "operacional.status.title": "Order status",
    "operacional.status.desc": "breakdown by status",
    "operacional.table.title": "Contracted services",
    "operacional.table.desc": "one row per line of the order spreadsheet",
    "operacional.table.empty.title": "no orders loaded",
    "operacional.table.empty.desc": "service orders appear here once the spreadsheet is imported or the API is connected",
    "operacional.table.count": "service(s)",
    "operacional.table.countZero": "0 services",
    "operacional.search": "exhibitor, tax ID or booth",
    "status.isento": "Exempt",
