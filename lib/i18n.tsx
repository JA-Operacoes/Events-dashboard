...
const DICT = {
  pt: {
    ...
    "financeiro.kpi.mediaComprador": "Média por comprador",
    ...
    "financeiro.origem.portaria": "Portarias",
    ...
    "operacional.table.title": "Pedidos de serviço",
    ...
    "operacional.table.count": "pedido(s)",
    "operacional.table.countZero": "0 pedidos",
    "operacional.search": "expositor, CNPJ ou estande",
    "status.recusado": "Recusado",
    "status.isento": "Isento",
    "status.semDebito": "Sem débito",
  ...
  en: {
    ...
    "financeiro.kpi.mediaComprador": "Average per buyer",
    ...
    "financeiro.origem.portaria": "Gate sales",
    ...
    "operacional.table.title": "Service orders",
    ...
    "operacional.table.count": "order(s)",
    "operacional.table.countZero": "0 orders",
    "operacional.search": "exhibitor, tax ID or booth",
    "status.recusado": "Declined",
    "status.isento": "Exempt",
    "status.semDebito": "No charge",
